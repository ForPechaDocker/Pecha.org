...
const AboutTopics = ({hideTitle}) => (
  <Module>
    ...
    <InterfaceText>
        <HebrewText>
            བརྗོད་གཞིའི་སྐོར་བསྒྱུར་བཞིན་པ་་་
        </HebrewText>
        <EnglishText>
            Topics bring you straight to selections of texts and user created source sheets about thousands of subjects. Sources that appear are drawn from existing indices of Buddhist texts (like The way of the bodhisattvas) and from the sources our users include on their public source sheets.
        </EnglishText>
...
const AboutCollections = ({hideTitle}) => (
  <Module>
    ...
    <InterfaceText>
        ...
        <HebrewText>ཕྱོགས་བསྒྲིགས་རྣམས་ནི་དཔེ་ཆ་ཚིགས་ནང་སྤྱོད་མཁན་རྣམས་ཀྱིས་གསར་བཟོ་བྱས་པའི་ཤོག་ངོས་ཁག་སྟེ་སྒེར་སྤྱོད་ཁོ་ན་བྱེད་པ་དང་ཡང་ན་གྲོགས་པོ་གཞན་ལ་བརྒྱུད་སྐུར་ཡང་ན་སྤྱི་སྤྱོད་ཅི་རིགས་བྱ་ཐུབ་པའི་དཔེ་ཚོགས་རྣམས་ལ་གོ།</HebrewText>
    </InterfaceText>
    {hideTitle ? null :
    <div>
